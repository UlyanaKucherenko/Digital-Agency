...
export const servicesList = [
  ...
  },
  {
    ...
    text: 'Promotion of your product is an important step in making money and constant popula...',
    icon: icon2,
    path: '/',
  },
  {
    title: 'Ui/UX Design',
    text: 'Everything starts with the beautiful. And professional design is of great importa...',
    icon: icon3,
    path: '/',
  },
];
